...
| [operator-guide/commissioning.md](operator-guide/commissioning.md) | **Commissioned zero** workflow in `cortex` / Link (persist zero, boot orchestrator, recovery). |
...
Also see [../README.md](../README.md) for build and URDF validation, and [../.cursor/rules/robotics-reference.mdc](../.cursor/rules/robotics-reference.mdc) for the same resource list inlined for Cursor agents.
