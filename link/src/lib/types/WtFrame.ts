 ...
 */
export type WtFrame = { "kind": "motor_feedback", "data": MotorFeedback } | { "kind": "system_snapshot", "data": SystemSnapshot } | { "kind": "test_progress", "data": TestProgress } | { "kind": "safety_event", "data": SafetyEvent };
