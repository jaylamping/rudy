...
pub const ALL: &[SettingDef] = &[
    ...
    SettingDef {
        key: "safety.current_watchdog_enabled",
        label: "Current watchdog enabled",
        description: "Enable host-side current watchdog evaluation from RobStride iqf telemetry.",
        category: "safety",
        unit: None,
        value_kind: "bool",
        min: None,
    ...
    SettingDef {
        key: "safety.current_trip_observe_only",
        label: "Current watchdog observe-only",
        description: "Log current threshold crossings without stopping/quarantining limbs.",
        category: "safety",
        unit: None,
        value_kind: "bool",
        min: None,
    ...
    SettingDef {
        key: "safety.current_trip_sustain_ms",
        label: "Current trip sustain (ms)",
        description: "How long current must exceed severe threshold before limb stop.",
        category: "safety",
        unit: Some("ms"),
        value_kind: "u64",
        min: Some(1.0),
    ...
    SettingDef {
        key: "safety.current_trip_min_motion_ms",
        label: "Current trip min motion (ms)",
        description: "Ignore current trips until planned motion has been active this long.",
        category: "safety",
        unit: Some("ms"),
        value_kind: "u64",
        min: Some(0.0),
    ...
    SettingDef {
        key: "safety.current_post_stop_safe_ratio",
        label: "Post-stop safe current ratio",
        description: "Current must fall below this ratio of effective limit_cur after a watchdog stop.",
        category: "safety",
        unit: None,
        value_kind: "f32",
        min: Some(0.0),
    ...
    SettingDef {
        key: "safety.current_post_stop_confirm_ms",
        label: "Post-stop confirm (ms)",
        description: "Window after limb stop before checking that current dropped.",
        category: "safety",
        unit: Some("ms"),
        value_kind: "u64",
        min: Some(1.0),
    ...
    SettingDef {
        key: "safety.current_i2t_warn_budget",
        label: "Current I2t warn budget",
        description: "Dimensionless current stress accumulator warning budget.",
        category: "safety",
        unit: None,
        value_kind: "f32",
        min: Some(0.0),
    ...
    SettingDef {
        key: "safety.current_i2t_trip_budget",
        label: "Current I2t trip budget",
        description: "Dimensionless current stress accumulator trip budget.",
        category: "safety",
        unit: None,
        value_kind: "f32",
        min: Some(0.0),
    ...
    SettingDef {
        key: "safety.current_i2t_decay_per_s",
        label: "Current I2t decay (/s)",
        description: "Accumulator decay rate when current returns toward normal.",
        category: "safety",
        unit: Some("1/s"),
        value_kind: "f32",
        min: Some(0.0),
    ...
    SettingDef {
        key: "safety.current_event_retention",
        label: "Current event retention",
        description: "Number of recent current safety incidents retained in memory.",
        category: "safety",
        unit: Some("events"),
        value_kind: "u32",
        min: Some(1.0),
...
pub fn value_from_merged(s: &SafetyConfig, t: &TelemetryConfig, key: &str) -> Option<Json> {
    let v = match key {
        ...
        "safety.current_watchdog_enabled" => json!(s.current_watchdog_enabled),
        "safety.current_trip_observe_only" => json!(s.current_trip_observe_only),
        "safety.current_trip_sustain_ms" => json!(s.current_trip_sustain_ms),
        "safety.current_trip_min_motion_ms" => json!(s.current_trip_min_motion_ms),
        "safety.current_post_stop_safe_ratio" => json!(s.current_post_stop_safe_ratio),
        "safety.current_post_stop_confirm_ms" => json!(s.current_post_stop_confirm_ms),
        "safety.current_i2t_warn_budget" => json!(s.current_i2t_warn_budget),
        "safety.current_i2t_trip_budget" => json!(s.current_i2t_trip_budget),
        "safety.current_i2t_decay_per_s" => json!(s.current_i2t_decay_per_s),
        "safety.current_event_retention" => json!(s.current_event_retention),
