...
use rudy_driver::{MitCommand, RobstrideCodec};

fn print_usage() {
    eprintln!(
        "rudy_driver_node — Rudy Robstride CAN tools\n\
         \n\
         Usage:\n\
           rudy_driver_node print-mit --motor-id <u8>\n\
         \n\
         Example:\n\
           rudy_driver_node print-mit --motor-id 1\n"
    );
}
